...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('public/assets/dist/img/AdminLTELogo.png') }}" alt="RedKarbet" class="brand-image img-circle elevation-3"
           style="opacity: .8">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2024 <a href="#">Developer: AlaaAlshafey</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
